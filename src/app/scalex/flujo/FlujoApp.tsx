  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-[var(--sx-text)]">Flujo — Finanzas y capital</h1>
      </div>

      <p className="-mt-3 mb-5 max-w-2xl text-sm leading-relaxed text-[var(--sx-text-muted)]">
      ...
      <div className="mb-6 flex items-start gap-3 rounded-2xl border border-[#1aab99]/20 bg-gradient-to-br from-[#1aab99]/[0.08] to-[#3533cd]/[0.06] p-4">
        ...
        <p className="text-sm italic leading-relaxed text-[var(--sx-text-muted)]">
      ...
      <p className="mb-3 text-xs font-bold uppercase tracking-wide text-[var(--sx-text-dim)]">Herramientas del pilar</p>
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <Link
          ...
          className="flex flex-col rounded-2xl border border-[var(--sx-border)] bg-[var(--sx-card)] p-5 transition hover:border-[var(--sx-border-strong)] hover:bg-[var(--sx-card-hover)]"
        >
          <div className="mb-3 flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="font-bold text-[var(--sx-text)]">Calculadora de Costos</div>
              <div className="text-xs text-[var(--sx-text-dim)]">Costeo</div>
            </div>
          </div>
          <p className="mb-4 flex-1 text-sm leading-relaxed text-[var(--sx-text-muted)]">
          ...
          <div className="flex items-center justify-between border-t border-[var(--sx-border)] pt-3">
            <span className="text-xs text-[var(--sx-text-dim)]">Productos · Gastos · Recursos</span>
        ...
        />
        <div className="flex flex-col rounded-2xl border border-[var(--sx-border)] bg-[var(--sx-card)] p-5 opacity-60">
          <div className="mb-3 flex items-start gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[var(--sx-card-hover)] text-[var(--sx-text-dim)]">
              <RefreshCw className="h-5 w-5" />
            </div>
            <div className="min-w-0 flex-1">
              <div className="font-bold text-[var(--sx-text-muted)]">Ciclo de Conversión</div>
              <div className="text-xs text-[var(--sx-text-dim)]">Próximamente</div>
            </div>
            <span className="rounded-full bg-[var(--sx-card-hover)] px-2.5 py-1 text-[11px] font-semibold text-[var(--sx-text-dim)]">Próximamente</span>
          </div>
          <p className="mb-4 flex-1 text-sm leading-relaxed text-[var(--sx-text-muted)]">
            Mide cuántos días tarda tu empresa en convertir inversión en efectivo. Optimiza el ciclo.
          </p>
          <div className="flex items-center gap-1.5 border-t border-[var(--sx-border)] pt-3 text-xs text-[var(--sx-text-dim)]">
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="font-bold text-[var(--sx-text)]">{titulo}</div>
          <div className="text-xs text-[var(--sx-text-dim)]">{tag}</div>
        </div>
      </div>
      <p className="mb-4 flex-1 text-sm leading-relaxed text-[var(--sx-text-muted)]">{desc}</p>
      <div className="flex items-center justify-between border-t border-[var(--sx-border)] pt-3">
        <span className="text-xs text-[var(--sx-text-dim)]">{meta}</span>
        <span className="flex items-center gap-1 text-xs font-semibold text-[#1aab99]"><ArrowRight className="h-3.5 w-3.5" /></span>
      </div>
    </div>
  );
