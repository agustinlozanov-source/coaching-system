...
import { BoardxSidebar } from '@/components/boardx/BoardxSidebar';
import { Header } from '@/components/dashboard/Header';

export default function BoardxLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`${theme === 'dark' ? 'dark' : ''} flex h-screen overflow-hidden bg-background text-foreground`}>
      <aside className="w-64 flex-shrink-0">
        <BoardxSidebar theme={theme} onToggleTheme={toggleTheme} />
      </aside>
